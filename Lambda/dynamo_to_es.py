...
ES_ENDPOINT = 'https://search-restaurants-7grqg7diy6bkcp2u6vmuqniu3a.us-east-1.es.amazonaws.com'

# The following parameters can be optionally customized
DOC_TABLE_FORMAT = 'restaurants'         # Python formatter to generate index name from the DynamoDB table name
DOC_TYPE_FORMAT = 'restaurants_type'     # Python formatter to generate type name from the DynamoDB table name, default is to add '_type' suffix
